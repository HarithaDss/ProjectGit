...
//Java script class on 24th July-->
//Updating the existing image using it's ID attribute : We will update the image seen above in this page with id=img1 -->
//These are not working for me !! My old image is as it is
document.getElementById("image1").style.width="100px";
document.getElementById("image1").src="New image location here";
